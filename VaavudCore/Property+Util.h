...
//static NSString * const KEY_MICROPHONE_HAS_ASKED = @"hasAskedForMicrophoneAccess";
static NSString * const KEY_MICROPHONE_HAS_APPROVED = @"hasApprovedMicrophoneAccess1";
