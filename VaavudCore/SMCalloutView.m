...
- (CGSize)offsetToContainRect:(CGRect)innerRect inRect:(CGRect)outerRect {
    ...
    //NSLog(@"innerRect:(x=%f,y=%f,width=%f,height=%f) outerRect:(x=%f,y=%f,width=%f,height=%f)", innerRect.origin.x, innerRect.origin.y, innerRect.size.width, innerRect.size.height, outerRect.origin.x, outerRect.origin.y, outerRect.size.width, outerRect.size.height);
    ...
    //NSLog(@"nudgeRight=%f, nudgeLeft=%f, nudgeTop=%f, nudgeBottom=%f, offset.width=%f, offset.height=%f", nudgeRight, nudgeLeft, nudgeTop, nudgeBottom, offset.width, offset.height);
